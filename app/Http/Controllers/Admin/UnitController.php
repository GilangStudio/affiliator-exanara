...
class UnitController extends Controller
{
    ...
    public function index(Request $request, Project $project)
    {
        ...
        return view('pages.admin.projects.units.index', compact('project', 'units'));
    }
    ...
    {
        return view('pages.admin.projects.units.create', compact('project'));
    }
    ...
    public function edit(Project $project, Unit $unit)
    {
        ...
        return view('pages.admin.projects.units.edit', compact('project', 'unit'));
    }
