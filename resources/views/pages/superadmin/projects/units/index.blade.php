    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('superadmin.projects.units.create', $project) }}" class="btn btn-primary">
                ...
                <form method="GET" class="row g-2">
                    ...
                    <div class="col-md-3">
                        <div class="btn-group w-100">
                            ...
                            <a href="{{ route('superadmin.projects.units.index', $project) }}" class="btn btn-outline-secondary">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="{{ route('superadmin.projects.units.edit', [$project, $unit]) }}" 
                                                   class="dropdown-item">
                                                    <i class="ti ti-edit me-2"></i>
                                                    Edit Unit
                                                </a>
                                                <form action="{{ route('superadmin.projects.units.toggle-status', [$project, $unit]) }}" 
                                                ...
                                                <button type="button" class="dropdown-item text-danger delete-btn"
                                                        data-name="{{ $unit->name }}" 
                                                        data-url="{{ route('superadmin.projects.units.destroy', [$project, $unit]) }}">
