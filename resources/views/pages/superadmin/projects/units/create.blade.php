...
@section('title', 'Tambah Unit - ' . $project->name)
    ...
    <div class="card-body">
        <div class="row align-items-center">
            ...
            <div class="col">
                ...
                <div class="text-secondary">Tambah Unit Baru</div>
            </div>
            <div class="col-auto">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('superadmin.projects.units.index', $project) }}">Unit</a></li>
...
<form action="{{ route('superadmin.projects.units.store', $project) }}" method="POST" enctype="multipart/form-data">
    @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('commission_type') is-invalid @enderror" 
                                    ...
                                    @foreach(App\Models\Unit::getCommissionTypes() as $key => $label)
                                        <option value="{{ $key }}" {{ old('commission_type') == $key ? 'selected' : '' }}>{{ $label }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('commission_value') is-invalid @enderror" 
                                           name="commission_value" value="{{ old('commission_value') }}" required min="0" step="0.1"
                                           placeholder="0">
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('land_area') is-invalid @enderror" 
                                           name="land_area" value="{{ old('land_area') }}" 
                                           placeholder="150">
                                    <span class="input-group-text">m²</span>
                                </div>
                                @error('land_area')
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('bedrooms') is-invalid @enderror" 
                                       name="bedrooms" value="{{ old('bedrooms') }}" min="0" placeholder="3">
                                @error('bedrooms')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('bathrooms') is-invalid @enderror" 
                                       name="bathrooms" value="{{ old('bathrooms') }}" min="0" placeholder="2">
                                @error('bathrooms')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('carport') is-invalid @enderror" 
                                       name="carport" value="{{ old('carport') }}" min="0" placeholder="1">
                                @error('carport')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('floor') is-invalid @enderror" 
                                       name="floor" value="{{ old('floor') }}" min="0" placeholder="1">
                                @error('floor')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <small class="form-hint">Centang untuk mengaktifkan unit setelah dibuat</small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-footer text-end">
                    <div class="d-flex">
                        <a href="{{ route('superadmin.projects.units.index', $project) }}" class="btn btn-link">
                            Batal
                        </a>
