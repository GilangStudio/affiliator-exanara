...
<form action="{{ route('admin.projects.admins.store', $project) }}" id="create-admin-form" method="POST" enctype="multipart/form-data">
    @csrf
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex align-items-center px-0">
                            ...
                            <span>Kelola admin lain (khusus PIC)</span>
                        </div>
                        <div class="list-group-item d-flex align-items-center px-0">
                            <i class="ti ti-x text-danger me-2"></i>
                            <span>Kelola unit (khusus PIC)</span>
                        </div>
                        <div class="list-group-item d-flex align-items-center px-0">
                            <i class="ti ti-x text-danger me-2"></i>
