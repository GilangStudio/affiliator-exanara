    ...
    <div class="card-body">
        <div class="row align-items-center">
            ...
            <div class="col">
                ...
                <div class="text-secondary">Edit Admin - {{ $admin->name }}</div>
            </div>
            <div class="col-auto">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.projects.admins.index', $project) }}">Admin</a></li>
...
<form action="{{ route('admin.projects.admins.update', [$project, $admin]) }}" id="edit-admin-form" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                ...
                <div class="card-body">
                    @if($admin->adminProjects->count() > 0)
                        <div class="list-group list-group-flush">
                            @foreach($admin->adminProjects as $assignedProject)
                            <div class="list-group-item d-flex align-items-center px-0">
                                @if($assignedProject->logo)
                                    <img src="{{ $assignedProject->logo_url }}" alt="{{ $assignedProject->name }}" 
                                         class="avatar avatar-sm me-2">
                                @else
                                    <div class="avatar avatar-sm bg-primary-lt me-2">
                                        {{ substr($assignedProject->name, 0, 1) }}
                                    </div>
                                @endif
                                <div class="flex-fill">
                                    ...
                                    <div class="text-secondary small">
                                        ...
                                        @if($assignedProject->id == $project->id)
                                            <span class="badge bg-blue-lt ms-1">Current</span>
                                        @endif
                                        @if($assignedProject->pic_user_id == $admin->id)
                                            <span class="badge bg-info-lt ms-1">PIC</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-footer text-end">
                    <div class="d-flex">
                        <a href="{{ route('admin.projects.admins.index', $project) }}" class="btn btn-link">
                            Batal
                        </a>
